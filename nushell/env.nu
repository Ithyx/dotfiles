...
$env.PATH = ($env.PATH | split row (char esep) | prepend '/home/ithyx/.local/bin')
$env.PATH = ($env.PATH | split row (char esep) | prepend '/home/root/.local/bin')

# Init oh my posh
oh-my-posh init nu --config /home/ithyx/.poshthemes/catppuccin.omp.json
